---
name: learn
description: use when the user ask you to explain what you have done in this session. for example, use when user says /learn, "tell me what you have done", "explain what we did".
---
